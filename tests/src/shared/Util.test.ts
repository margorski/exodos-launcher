...
describe("Shared Utils", () => {
    ...
    test("Stringify Array", () => {
        ...
        expect(stringifyArray(array, optsTrimmed)).toEqual(
            formattedArrayTrimmed,
        );
    });
...
describe("HTML Utils", () => {
    test("Escape HTML", () => {
        expect(escapeHTML("<html><p>Test & Success</p></html>")).toBe(
            "&lt;html&gt;&lt;p&gt;Test &amp; Success&lt;/p&gt;&lt;/html&gt;",
        );
    });
    ...
    test("Unescape HTML", () => {
        ...
        ).toBe("<html><p>Test & Success</p></html>");
    });
});
