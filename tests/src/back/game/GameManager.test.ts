...
describe("GameManager", () => {
    ...
    test("Add Games & AddApps (to the same and already existing platform)", () => {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            expect(platform).toEqual({
                // Game & AddApps have been added to the end of the collections in the correct order
                ...before,
                data: {
                    LaunchBox: {
                        Game: [
                ...
                collection: {
                    ...
                    additionalApplications: [
                        ...before.collection.additionalApplications,
                        ...addApps,
                    ],
                },
            });
    ...
    test("Move Game & AddApps (between existing platforms)", () => {
        ...
        // Compare
        expect(fromPlatform).toEqual({
            // First platform is empty
            ...fromPlatform,
            data: {
                LaunchBox: {
                    Game: [],
        ...
        expect(toPlatform).toEqual({
            // Second platform has the game and add-apps
            ...toPlatform,
            data: {
                LaunchBox: {
    ...
    test("Update Game (update the value of a field)", () => {
        ...
        expect(platform).toEqual({
            // Game has been added to the platform
            ...before,
            data: {
                LaunchBox: {
    ...
    test("Remove Games & AddApps (from one platform)", () => {
        ...
        for (let i = platform.collection.games.length - 1; i >= 0; i--) {
            ...
            // Compare
            expect(platform).toEqual({
                // Game & AddApps have been removed
                ...before,
                data: {
                    LaunchBox: {
