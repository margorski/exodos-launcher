...
export function stringifyBrowsePageLayout(
    layout: BrowsePageLayout,
): BrowsePageLayoutString | undefined {
    switch (layout) {
        case BrowsePageLayout.list:
            return "list";
        case BrowsePageLayout.grid:
            return "grid";
    }
    return undefined;
}
...
export function parseBrowsePageLayout(
    str: string,
): BrowsePageLayout | undefined {
    switch (str) {
        case "list":
            return BrowsePageLayout.list;
        case "grid":
            return BrowsePageLayout.grid;
    }
    return undefined;
}
