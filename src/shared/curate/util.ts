 ...
 */
export function getCurationFolder(
    curation: CurationIndex | EditCuration,
    fpPath: string,
): string {
 ...
 */
export async function indexContentFolder(
    contentPath: string,
...
export async function recursiveFolderIndex(
    folderPath: string,
    basePath: string,
