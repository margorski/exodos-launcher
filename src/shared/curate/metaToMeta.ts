 ...
 */
export function convertToCurationMeta(
    game: IGameInfo,
 ...
 */
export function convertEditToCurationMeta(
    curation: EditCurationMeta,
 ...
 * @param addApps Additional applications of the curation.
 */
export function convertParsedToCurationMeta(
    curation: ParsedCurationMeta,
): CurationFormatMeta {
    const parsed: CurationFormatMeta = {};
    // Edit curation meta
