...
export class App extends React.Component<AppProps, AppState> {
    ...
    init() {
        ...
        ipcRenderer.on(
            ...
            debounce((sender, x: number, y: number, isMaximized: boolean) => {
                if (!isMaximized) {
                ...
                case BackOut.EXODOS_STATE_UPDATE:
                    {
                        ...
                        const exodosState: ExodosStateData = {
                            gamesEnabled: resData.gamesEnabled
                                ? resData.gamesEnabled
                                : this.state.exodosState.gamesEnabled,
                            magazinesEnabled: resData.magazinesEnabled
                                ? resData.magazinesEnabled
                                : this.state.exodosState.magazinesEnabled,
                        };
                        this.setState({
