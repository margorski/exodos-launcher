...
export function PlaylistItemContent(props: PlaylistItemContentProps) {
    ...
    if (props.editing) {
        className += " playlist-list-content--edit";
    }
                ...
                {props.editingDisabled ? undefined : (
                    <div className="playlist-list-content__edit">
                        <div className="playlist-list-content__id">
                            <p className="playlist-list-content__id-pre">
                                {strings.filename}:{" "}
                            </p>
                            <div className="playlist-list-content__id-text">
                                <InputField
                                    ...
                                    editable={
                                        props.editing && !props.editingDisabled
                                    }
...
function renderDeleteButton({
    ...
    reset,
    extra,
}: ConfirmElementArgs<LangContainer["playlist"]>): JSX.Element {
    return (
        <div
            className={
                "playlist-list-content__button playlist-list-content__button--warning" +
                (activationCounter > 0
                    ? " playlist-list-content__button--active simple-vertical-shake"
                    : "")
            }
