			...
			<div className="home-page__box home-page__box_narrow">
				...
				<ul className="home-page__box-body">
					...
					<QuickStartItem icon="cog">
						<Link to="#" onClick={() => onLaunchCommand("Setup.sh")}>
							eXoDOS Setup
						</Link>
					</QuickStartItem>
			...
			<div className="home-page__box home-page__box_narrow">
				...
				<ul className="home-page__box-body">
					<QuickStartItem icon="script">
						<Link to="#" onClick={() => onLaunchCommand("eXoDOS ReadMe.txt")}>
							ReadMe
						</Link>
					</QuickStartItem>
					<QuickStartItem icon="script">
					...
					<QuickStartItem icon="book">
						<Link to="#" onClick={() => onLaunchCommand("eXoDOS Manual.pdf")}>
							Manual
						</Link>
					</QuickStartItem>
					<QuickStartItem icon="book">
						<Link to="#" onClick={() => onLaunchCommand("eXoDOS Catalog.pdf")}>
							Catalog
						</Link>
					</QuickStartItem>
				</ul>
		...
		() => (
			<div className="home-page__box">
				...
				<div className="home-page__box-body">
					<p>
						This pack includes 7,200 DOS games. The games have already been
						configured to run in DOSBox. Games which are supported by ScummVM
						will give you the option at launch as to which emulator you would
						like to use.
					</p>
					<br />
					<p>
						If you have not already done so, run the utilities in the Setup box
						to install the collection on your computer. Then, click on the
						MS-DOS tab to browse through and play the games, or the DOS
						Magazines tab to read magazines.
					</p>
				</div>
			</div>
		),
		...
		<div className="home-page__two_columns_container">
			<div className="home-page__header">
				<div className="">
					...
					<div>
						<h4>{`backend: ${
							props.exodosBackendInfo ? props.exodosBackendInfo.version : ""
						}`}</h4>
					</div>
					<div>
...
function QuickStartItem(props: {
	...
	return (
		<li
			className={"home-page__box-item simple-center " + (props.className || "")}
		>
			{props.icon ? (
			...
			<div className="simple-center__vertical-inner">{props.children}</div>
		</li>
	);
}
