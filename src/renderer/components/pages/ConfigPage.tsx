...
> {
    ...
    render() {
        ...
        const langOptions = this.renderLangOptionsMemo(
                                    ...
                                    <div className="setting__row__content setting__row__content--toggle">
                                        <div>
                                            <select
                                                ...
                                                onChange={
                                                    this.onCurrentLanguageSelect
                                                }
                                            >
                                                <option value={autoCode}>
                                                    {autoString}
                                                </option>
                                                {langOptions}
                                            </select>
