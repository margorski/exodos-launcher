...
export type InputFieldProps = {
    ...
    onClick?: (
        event: React.MouseEvent<InputElement | HTMLParagraphElement>,
    ) => void;
...
export function InputField(props: InputFieldProps) {
    ...
    if (disabled) {
        cleanClassName += " simple-input--disabled";
    }
    if (editable) {
        if (multiline) {
            return (
                <textarea
                    ...
                    onKeyDown={onKeyDown}
                    className={
                        "input-field input-field--multiline input-field--edit simple-input simple-scroll" +
                        cleanClassName
                    }
                />
            );
            ...
            return (
                <input
                    ...
                    onKeyDown={onKeyDown}
                    className={
                        "input-field input-field--edit simple-input" +
                        cleanClassName
                    }
                />
            );
        ...
        let cn = "input-field";
        if (!text) {
            cn += " simple-disabled-text";
        }
        if (multiline) {
            cn += " input-field--multiline";
        }
        if (className) {
            cn += cleanClassName;
        }
