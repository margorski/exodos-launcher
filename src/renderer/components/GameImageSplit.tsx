 ...
 */
export class GameImageSplit extends React.Component<
    GameImageSplitProps,
    GameImageSplitState
> {
    ...
    render() {
        ...
        if (imgSrc === undefined) {
            className += " simple-center";
        }
        if (hover) {
            className += " game-image-split--hover";
        }
        if (disabled) {
            className += " game-image-split--disabled";
        }
        // Render
        return (
            <div
    ...
    return (
        <div
            className={
                ...
                (activationCounter > 0
                    ? " game-image-split__buttons__remove-image--active simple-vertical-shake"
                    : "") +
                (disabled
                    ? " game-image-split__buttons__remove-image--disabled"
                    : "")
            }
